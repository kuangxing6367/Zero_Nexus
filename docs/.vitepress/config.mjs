...
export default defineConfig({
  ...
  themeConfig: {
    nav: [
      ...
      { text: '更新日志', link: 'https://github.com/kuangxing6367/Zero_Nexus/blob/main/CHANGELOG.md' },
      { text: 'GitHub', link: 'https://github.com/kuangxing6367/Zero_Nexus' }
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/kuangxing6367/Zero_Nexus' }
    ],
    ...
    footer: {
      ...
      copyright: 'Copyright © 2026 Zeronus'
    },
