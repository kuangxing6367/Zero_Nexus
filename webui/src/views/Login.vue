  ...
  <div class="login-wrap">
    <div class="login-card">
      <div class="login-logo">
        <img :src="logoUrl" alt="Zeronus" class="login-logo-img" />
      </div>
      <h1 class="login-title">Zeronus 管理面板</h1>
...
async function checkExisting() {
  if (!localStorage.getItem('zernus_token')) return
  try {
